...
describe TaxaController do
  ...
  describe "provisional" do
    ...
    it "should not allow curators to set provisional to false on existing prov taxon with major epithet changes" do
      t = Taxon.make!( name: "Cortinarius sp. 'test'", rank: Taxon::SPECIES, parent: cortinarius, provisional: true )
      curator = make_curator
      sign_in curator
      expect( t.provisional ).to be( true )
    ...
    it "should not allow curators to change genus when setting provisional to false" do
      t = Taxon.make!( name: "Cortinarius sp. 'test'", rank: Taxon::SPECIES, parent: cortinarius, provisional: true )
      curator = make_curator
      sign_in curator
      expect( t.provisional ).to be( true )
