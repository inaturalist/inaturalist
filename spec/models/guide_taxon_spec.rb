...
describe GuideTaxon do
  ...
  let( :local_photo_from_remote_photo ) { LocalPhoto.make }

  before do
    allow( Photo ).to receive( :local_photo_from_remote_photo ).and_return(
  ...
  describe "deletion" do
    it "should update the guide's taxon id" do
      without_delay do
        ...
        t2 = Taxon.make!
        GuideTaxon.make!( guide: g, taxon: t1 )
