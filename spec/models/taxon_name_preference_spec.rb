...
describe TaxonNamePreference do

  it { is_expected.to belong_to :user }
  it { is_expected.to belong_to :place }

  describe "uniqueness validations" do
    subject { TaxonNamePreference.make!( lexicon: "english" ) }
  ...
  describe "creation" do
    it "should create with the next highest position" do
      u = User.make!
      tnp1 = TaxonNamePreference.make!( user: u, lexicon: "l1" )
      expect( tnp1.position ).to be 0
      tnp2 = TaxonNamePreference.make!( user: u, lexicon: "l2" )
      expect( tnp2.position ).to be 1
      tnp3 = TaxonNamePreference.make!( user: u, lexicon: "l3", position: 100 )
      expect( tnp3.position ).to be 100
      tnp4 = TaxonNamePreference.make!( user: u, lexicon: "l4" )
