...
ActiveRecord::Schema.define(:version => 20130208003925) do
  ...
  create_table "lists", :force => true do |t|
    ...
    t.integer  "project_id"
    t.integer  "source_id"
    t.boolean  "show_obs_photos", :default => true
  end
  ...
  create_table "projects", :force => true do |t|
    ...
    t.boolean  "delta",                                               :default => false
    t.integer  "place_id"
    t.string   "map_type",                                            :default => "terrain"
    t.decimal  "latitude",            :precision => 15, :scale => 10
    t.decimal  "longitude",           :precision => 15, :scale => 10
    t.integer  "zoom_level"
  end

  add_index "projects", ["place_id"], :name => "index_projects_on_place_id"
  ...
  add_index "updates", ["resource_type", "resource_id", "notifier_type", "notifier_id", "subscriber_id", "notification"], :name => "updates_unique_key", :unique => true
