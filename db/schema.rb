...
ActiveRecord::Schema.define(:version => 20120906014934) do
  ...
  create_table "custom_projects", :id => false, :force => true do |t|
  ...
  add_index "friendly_id_slugs", ["name", "sluggable_type", "sequence", "scope"], :name => "index_slugs_on_n_s_s_and_s", :unique => true
