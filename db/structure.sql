...
CREATE TABLE public.taxon_references (
    id integer NOT NULL,
    description text,
...
CREATE SEQUENCE public.taxon_references_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.taxon_references_id_seq OWNED BY public.taxon_references.id;
...
ALTER TABLE ONLY public.taxon_references ALTER COLUMN id SET DEFAULT nextval('public.taxon_references_id_seq'::regclass);
...
ALTER TABLE ONLY public.taxon_references
...
CREATE INDEX index_taxa_on_taxon_reference_id ON public.taxa USING btree (taxon_reference_id);
...
ALTER TABLE ONLY public.taxa
    ADD CONSTRAINT fk_rails_86d19277a3 FOREIGN KEY (taxon_reference_id) REFERENCES public.taxon_references(id);
