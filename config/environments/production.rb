Inaturalist::Application.configure do
  ...
  config.cache_store = :mem_cache_store, CONFIG.get(:memcached)
  ...
  if CONFIG.get(:google_analytics) && CONFIG.get(:google_analytics, :tracker_id)
    config.middleware.use "Rack::GoogleAnalytics", :web_property_id => CONFIG.get(:google_analytics, :tracker_id)
  end
end
