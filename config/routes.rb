ActionController::Routing::Routes.draw do |map|
  ...
  map.wikimedia_commons_photo_fields "/wikimedia_commons/photo_fields", :controller => "wikimedia_commons", :action => "photo_fields"
  ...
  map.photo_repair "/photos/:id/repair", :controller => "photos", :action => "repair", :method => :put
  ...
  map.resources :taxon_stages, :controller => :taxon_changes
