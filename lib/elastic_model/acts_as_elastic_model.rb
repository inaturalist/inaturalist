  ...
  included do
    ...
    def elastic_index!
      ...
      begin
        ...
        # TODO Rails 5: re-implement this since association_cache is no longer public: https://github.com/rails/rails/pull/16989. Might just need to call reset on all associations
