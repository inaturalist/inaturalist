ThinkingSphinx::Index.define :project, with: :active_record, delta: ThinkingSphinx::Deltas::DelayedDelta do
  ...
  # has "SELECT projects.id * 4::INT8 + 2 AS id, regexp_split_to_table(projects.place_id::text ||
  #   (CASE WHEN ancestry IS NULL THEN '' ELSE '/' || ancestry END), '/')
  #   AS place_id FROM projects JOIN places ON projects.place_id = places.id",
  #   as: :place_ids, source: :query
end
