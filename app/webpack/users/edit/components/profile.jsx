...
const Profile = ( { profile } ) => (
  <div className="col-md-9">
    <div className="row">
      <div className="col-sm-6 two-column-height">
        ...
        <div className="profile-setting">
          <h5 className="margin-medium">
            {I18n.t( "change_password" )}
            <div className="downward-caret">&#x25BE;</div>
          </h5>
          <form className="margin-medium-small">
            <label className="small">{I18n.t( "new_password" )}</label>
            <input type="text" className="form-control" />
          </form>
          <form className="margin-medium">
            <label className="small">{I18n.t( "confirm_new_password" )}</label>
            <input type="text" className="form-control" />
          </form>
          <button className="btn btn-xs btn-primary" type="button">
            {I18n.t( "change_password" )}
        ...
        <div className="col-sm-9 column-spacing">
          <div className="profile-setting">
            <h5>
              {I18n.t( "display_name" )}
              <div className="asterisk">*</div>
          ...
          <div className="profile-setting">
            <h5 className="margin-medium">{I18n.t( "badges" )}</h5>
