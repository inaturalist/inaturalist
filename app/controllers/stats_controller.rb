class StatsController < ApplicationController
  ...
  def canada_150
    project_slideshow_data( 12849,
      ...
      sub_project_ids: {
        12849 => [11863, 12646, 12281, 11396, 11693, 10595, 12189, 12192, 12743, 12511, 12872, 12748, 11440, 12806, 13124, 12210, 13176, 12024, 13377, 13376, 13375, 13374, 12597, 12166, 11451]
      },
