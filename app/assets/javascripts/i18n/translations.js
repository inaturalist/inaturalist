...
I18n.translations["es"] = {
  ...
  "project": "Proyecto",
  "projects": "Proyectos",
  "proposed_taxa_that_contradict_the_community_id": "Taxas propuestas que contradicen la identificación de la comunidad",
  "proposed_taxa_that_support_the_community_id": "Taxa propuesta que respalda la identificación de la comunidad",
  "protozoans": "protozoarios",
  "public_domain": "Dominio público",
  "purple": "púrpura",
  ...
  "x_of_y": "%{x} de %{y}",
  "x_of_y_people_over_two_thirds_agree_it_is": "%{x} de %{y} personas (más de 2/3) aceptan que es",
  "x_others": {
    "one": "1 más",
    "other": "%{count} más"
  },
