...
(function($){
  ...
  function buildControls(wrapper, options) {
    ...
    if (options.bootstrap) {
      var prev = $('<button type="button" class="prevlink btn btn-default">&laquo; '+I18n.t('prev_page_short')+'</button>')
      var next = $('<button type="button" class="nextlink btn btn-default">'+I18n.t('next_page_short')+' &raquo;</button>')
    } else {
      var prev = $('<a href="#" class="prevlink button">&laquo; '+I18n.t('prev_page_short')+'</a>')
