module Shared::SweepersModule
  ...
  def self.included(base)
    base.extend ActionController::Caching::Fragments
  ...
  module ExpireHelpers
    ...
    def expire_listed_taxon(listed_taxon)
      controller.expire_fragment(:controller => 'listed_taxa', :action => 'show', :id => listed_taxon)
      controller.expire_fragment(:controller => 'listed_taxa', :action => 'show', :id => listed_taxon, :for_owner => true)
