class Notification < ActiveRecord::Base
  ...
  def notifier_is_annotation?
    primary_notifier.notifier.resource_type == "Annotation"
  end
  ...
  def as_json( options = nil )
    ...
    elsif resource_is_observation? && notifier_is_annotation?
      statement += " added an annotation to"
    end
